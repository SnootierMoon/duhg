...
impl State {
    async fn new(window: Window) -> Self {
        ...
        let sphere = hexasphere::shapes::IcoSphere::new(10, |_| ());

        let center = Vec3A::new(0.0, 0.0, 0.0);
        let min_radius = 0.6f32;
        ...
        let vertices = sphere
            ...
            .iter()
            .map(|point| {
                let height = (n.get(point.as_dvec3().to_array()) / 2.0 + 0.5) as f32;
                println!("{height}");
                let radius = (max_radius - min_radius) * height + min_radius;
                let point = (center + *point) * radius;
